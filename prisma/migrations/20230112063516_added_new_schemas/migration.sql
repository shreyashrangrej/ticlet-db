/*
  ...
  - The values [VANILLA,CLIENT,AGENT,SUPPORT,MANAGER,ADMINISTRATOR] on the enum `UserType` will be removed. If these variants are still used in the database, this will fail.
...
-- AlterEnum
BEGIN;
CREATE TYPE "UserType_new" AS ENUM ('client', 'agent', 'support', 'manager', 'administrator');
...
ALTER COLUMN "userType" SET DEFAULT 'client';
